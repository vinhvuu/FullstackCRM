...
__decorate([
    ...
    __param(0, (0, common_1.Param)('dealId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('lineItemId', common_1.ParseIntPipe)),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], LineItemsController.prototype, "delete", null);
exports.LineItemsController = LineItemsController = __decorate([
    (0, common_1.Controller)('deals/:dealId/line-items'),
