export declare const SALES_DEAL_SERVICE: unique symbol;
export declare const SALES_PRODUCT_SERVICE: unique symbol;
export declare const SALES_QUOTE_SERVICE: unique symbol;
...
export interface ISalesDealService {
    ...
    forecastBuckets(periodKey: string, ownerId?: number): Promise<{
        committed: number;
        best_case: number;
        pipeline: number;
    }>;
