export declare const PLATFORM_NOTIFICATION_SERVICE: unique symbol;
export declare const PLATFORM_SAVED_VIEW_SERVICE: unique symbol;
export declare const PLATFORM_CUSTOM_FIELD_SERVICE: unique symbol;
export declare const PLATFORM_SEARCH_SERVICE: unique symbol;
...
export interface IPlatformNotificationService {
    ...
    createMany(userIds: number[], input: {
        type: string;
        title: string;
        body?: string;
        link?: string;
...
export interface IPlatformSavedViewService {
    ...
    applyView(id: number, userId: number): Promise<{
        filters: any;
        columns: string[];
        sort?: string;
    }>;
...
export interface IPlatformCustomFieldService {
    ...
    getValues(entity: string, recordId: number): Promise<{
        fieldKey: string;
        value: string;
    }[]>;
    setValues(entity: string, recordId: number, values: {
        fieldKey: string;
        value: any;
    }[]): Promise<void>;
    validateValues(entity: string, recordId: number, values: {
        fieldKey: string;
        value: any;
    }[]): Promise<{
        ok: boolean;
